...
@include('shared.sidebar', ['active' => "entrepreneur-products"])
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">Gestion des produits B2B</a>
                </div>
                           ...
                           <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <div class="col-sm-12 createProduct margin-bottom">
                                    ...
                                    <form class="form-inline" method="POST" action="/entrepreneurs/product/create">
                                        {{ csrf_field() }}
                                    ...
                                    <tbody>
                                        @if(count($products) > 0)
                                            @foreach ($products as $prod)
                                                <tr>
                                                    <form method="POST" action="/entrepreneurs/product/update/{{$prod->id}}">
                                                        {{ csrf_field() }}
                                                        <td>{{$prod->id}}</td>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="/entrepreneurs/product/delete/{{$prod->id}}" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce produit ?');">
                                                            {{ csrf_field() }}
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" align="center">
                                                    Aucun produit enregistré actuellement.
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
