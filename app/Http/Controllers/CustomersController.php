...
/*     public function testTagpay() {
        $dataSurvey = array(
            "survey_type" => "Entrepreneur",
            "enqueteur_id" => "123",
        );
        Mail::send('emails.survey', $dataSurvey, function ($m) {
 ...
 */
    public function getCustomerProfile(Request $request, $entrepreneurId, $customerNum) {
        ...
        if($customer) {
            ...
            $customerData = array(
                ...
                "job"                   => $customer->job,
                "equipment_wish"        => $customer->equipment_wish,
    ...
    public function createCustomer(Request $request, $entrepreneurId) {
        ...
        if($checkExist) {
            ...
            $customer->telephone = $request->clientTel;
